...
public class ForgeProgressScreen extends ScreenGui {
    ...
    public class Panel extends PanelGui {
        ...
        public class MessagePanel extends PanelGui {
            ...
            public void render(FullResRenderer r, Graphics2D g) {
                ...
                int marginX = app.resolveXAbs(MARGIN_LEN), marginY = app.resolveYAbs(MARGIN_SMALL_LEN);
                int textLeft = app.resolveXAbs(position.x()) + marginX;
                int textRight = r.toScreenX(right()) - marginX;
