...
public class CollectionUtils {
    ...
    public static <T> ArrayList<T> toArrayList(T[] styles) {
        return Arrays.stream(styles).collect(ArrayList::new, ArrayList::add, ArrayList::addAll);
    }
    ...
    @SafeVarargs
    public static <T> List<T> append(List<T> list, T... others) {
        list.addAll(Arrays.asList(others));
        return list;
    }

    public static <T> List<T> append(List<T> list, Collection<T> others) {
        list.addAll(others);
        return list;
    }
}
